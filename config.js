...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Manu-MD&CVdDzL7Q#CiHy3TMrJNOZie1SKDIpJ0-g__s36rztqPtckvK6T3g",
...
OWNER_NUMBER : process.env.OWNER_NUMBER || "2349165661959",
DELCHAT : process.env.DELCHAT || "del",
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? 'del' : process.env.DELETEMSGSENDTO,
};
